...
SENSORS = [
    ...
    Sensor("temp"                  , "Coolant Temp"					, "0105" , temp             ,""      ),
    ...
    Sensor("manifold_pressure"     , "Intk Manifold"				, "010B" , intake_m_pres    ,""    ),
    Sensor("rpm"                   , "Engine RPM"					, "010C", rpm              ,""       ),
    Sensor("speed"                 , "Vehicle Speed"				, "010D", speed            ,""    ),
    Sensor("timing_advance"        , "Timing Advance"				, "010E" , timing_advance   ,""),
    Sensor("intake_air_temp"       , "Intake Air Temp"				, "010F" , temp             ,""      ),
    Sensor("maf"                   , "AirFlow Rate(MAF)"			, "0110" , maf              ,"" ),
    ...
    Sensor("engine_time"           , "Engine Start MIN"				, "011F" , sec_to_min       ,""    ),
    Sensor(""       , "Distance traveled with malfunction indicator lamp (MIL) on"               , "0121" , None,""    ),
    Sensor(""       , "Fuel Rail Pressure (relative to manifold vacuum)"               , "0122" , None,""    ),
    Sensor(""       , "Fuel Rail Gauge Pressure (diesel, or gasoline direct injection)"               , "0122" , None,""    ),
    Sensor("engine_mil_time"       , "Engine Run MIL"				, "014D" , sec_to_min       ,""    ),
